package com.devonfw.bookshop.orderservice.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the orderservice application.
 */
