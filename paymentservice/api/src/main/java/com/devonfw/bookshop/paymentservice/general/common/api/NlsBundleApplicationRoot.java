package com.devonfw.bookshop.paymentservice.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.devonfw.bookshop.paymentservice.general.common.api.exception.NoActiveUserException
   *
