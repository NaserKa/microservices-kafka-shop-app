package com.devonfw.bookshop.catalogservice.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.devonfw.bookshop.catalogservice.general.common.api.exception.NoActiveUserException
   *
