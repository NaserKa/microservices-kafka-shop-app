...
CREATE TABLE Product (
  ...
  lastProductNumber INTEGER NOT NULL AUTO_INCREMENT,
  CONSTRAINT PK_Product PRIMARY KEY(id)
);

DELETE FROM Product;

INSERT INTO Product(modificationCounter, name, description, price, quantity) VALUES (1, 'MacBook', 'Laptop', 1299.50, 100);
INSERT INTO Product(modificationCounter, name, description, price, quantity) VALUES (2, 'Lenovo', 'PC', 500.20, 50);
