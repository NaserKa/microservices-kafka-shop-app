package com.devonfw.bookshop.customerservice.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.devonfw.bookshop.customerservice.general.common.api.exception.NoActiveUserException
   *
