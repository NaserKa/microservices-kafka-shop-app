package com.devonfw.bookshop.customerservice.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the customerservice application.
 */
