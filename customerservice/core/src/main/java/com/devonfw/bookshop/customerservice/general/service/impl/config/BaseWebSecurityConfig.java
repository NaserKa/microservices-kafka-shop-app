package com.devonfw.bookshop.customerservice.general.service.impl.config;
...
import com.devonfw.bookshop.customerservice.general.common.impl.security.CsrfRequestMatcher;
...
public abstract class BaseWebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    http.antMatcher("/services/**").csrf().disable();
  }
